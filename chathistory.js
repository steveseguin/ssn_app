...
function compareMessagesNewestFirst(a, b) {
    return b.timestamp - a.timestamp || indexedDB.cmp(b.id, a.id);
}
...
function handleImageError(event) {
    ...
    if (img.classList.contains('avatar') && img.src !== 'https://cache.socialstream.ninja/sources/images/unknown.png') {
